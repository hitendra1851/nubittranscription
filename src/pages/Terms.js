        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-600 mb-6">
              ...
              non-exclusive license to process your content solely for the purpose of providing transcription services.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Payment Terms</h2>
            <p className="text-gray-600 mb-4">
              Certain aspects of the Service may be provided for a fee. You agree to pay all fees associated with your use 
              of paid features. Payment terms include:
            </p>
            <ul className="list-disc list-inside text-gray-600 mb-6 space-y-2">
              <li>Fees are charged in advance on a monthly or annual basis</li>
              <li>All fees are non-refundable except as required by law</li>
              <li>We reserve the right to change our pricing with 30 days notice</li>
              <li>Failure to pay fees may result in suspension of service</li>
            </ul>
